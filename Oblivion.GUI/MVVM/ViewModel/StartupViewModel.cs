...
{
    public partial class StartupViewModel(AppNavigationService navigationService,
        ...
        FileExportService fileExportService) : ViewModelBase
    {
        ...
        [ObservableProperty]
        private ObservableCollection<WorkspaceUIModel> workspaces = new();
        ...
        // Rename file state
        [ObservableProperty]
        private bool _isRenamingFile = false;
        ...
        // Move file state
        [ObservableProperty]
        private bool _isMovingFile = false;
        ...
        private void Analyze()
        {
            ...
            var vm = new AnalysisViewModel(SelectedFile, snapshot);
        ...
        private async Task ConfirmRenameFolder()
        {
            ...
            // Force TreeView to refresh the item
        ...
        public async Task ImportFilesFromPaths(string[] filePaths, WorkspaceUIModel workspace)
        {
            ...
            try
            {
                // Analyze all files in parallel on thread-pool
            ...
            foreach (var ws in Workspaces)
            {
                foreach (var file in ws.Files)
                {
                    file.IsVisible = string.IsNullOrEmpty(filter) ||
                                     file.Name.Contains(filter, System.StringComparison.OrdinalIgnoreCase);
                }
            }
        }
